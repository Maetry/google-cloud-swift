...
public struct GoogleCloudPubSubConfiguration: GoogleCloudAPIConfiguration {
    ...
    public init(scope: [GoogleCloudPubSubScope], serviceAccount: String = "default", project: String? = nil) {
        self.scope = scope
        self.serviceAccount = serviceAccount
        self.project = project
    }
    
    /// Create a new `GoogleCloudPubSubConfiguration` with cloud platform scope and the default service account.
